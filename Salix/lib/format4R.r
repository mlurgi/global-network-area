...
#### This code was provided by Professor Tomas Roslin
#### It is used to read the main raw data file and create separate data structures
#### for each network type and constituent species
