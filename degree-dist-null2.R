...
cur_fit_galpar <- read.csv('./Salix/fits-degree-galpar-null-model-2.csv')
...
write.csv(modified_fit_table, './Salix/fits-degree-dists-galpar-fraction-null2.csv')

cur_fit_salgal <- read.csv('./Salix/fits-degree-salgal-null-model-2.csv')
...
write.csv(modified_fit_table, './Salix/fits-degree-dists-salgal-fraction-null2.csv')


cur_fit_pyrenees <- read.csv('./Pyrenees/fits-degree-dists-pyrenees-null-model-2.csv')
...
write.csv(modified_fit_table, './Pyrenees/fits-degree-dists-pyrenees-fraction-null2.csv')
...
for(bior in european_bioregions){
  cur_fit_data <- read.csv('./European-Bioregions/fits-degree-dists-europe-null-model-2-2.csv')[-1]
  if(bior=='blacksea'){
  ...
  write.csv(modified_fit_table, paste0('./European-Bioregions/',bior,'/fits-degree-dists-',bior,'-fraction-null2.csv'))
}


#### now let's do the replicates #'Bristol'
datasets <- c('Chaco', 'Quercus', 'Nahuel', 'Gottin-HP', 'Gottin-PP', 'Sanak', 'Garraf-HP', 'Garraf-PP', 'Garraf-PP-2', 'Olot', 'Montseny','Bristol')
for(dset in datasets){
  ...
  cur_fit_data <- read.csv(paste0('./',folder,'/fits-degree-dists-',tolower(dset),'-null-model-2.csv'))[-1]
  ...
  write.csv(modified_fit_table, paste0('./',folder,'/fits-degree-dists-', tolower(dset),'-fraction-null2.csv'))
}


#### for mulder's dataset this is a bit different because of the 7 different categories
cur_all_data <- read.csv(paste0('./Soils/fits-degree-dists-soils-null-model-2.csv'))[-1]
modified_fit_table <- NULL
...
write.csv(modified_fit_table, paste0('./Soils/fits-degree-dists-soils-fraction-null2.csv'))
...
cur_fits <- read.csv('./Soils/fits-degree-dists-soils-fraction-null2.csv')
cur_fits <- cur_fits[c('s_type','area','model','a','b')]
cur_fits$s_type <- paste0('soils-',cur_fits$s_type)

datasets <- c('fits-degree-dists-chaco-fraction-null2.csv', 'fits-degree-dists-gottin-pp-fraction-null2.csv',
              'fits-degree-dists-gottin-hp-fraction-null2.csv', 'fits-degree-dists-quercus-fraction-null2.csv',
              'fits-degree-dists-montseny-fraction-null2.csv','fits-degree-dists-garraf-pp-2-fraction-null2.csv', 
              'fits-degree-dists-garraf-pp-fraction-null2.csv', 'fits-degree-dists-nahuel-fraction-null2.csv',
              'fits-degree-dists-garraf-hp-fraction-null2.csv', 'fits-degree-dists-olot-fraction-null2.csv',
              'fits-degree-dists-sanak-fraction-null2.csv', 'fits-degree-dists-bristol-fraction-null2.csv')

for(d in datasets){
  name <- strsplit(strsplit(d, 'fits-degree-dists-')[[1]][2], '.csv')[[1]]
  name <- strsplit(strsplit(name, '-fraction-null2')[[1]][1], '.csv')[[1]]
...
cur_fit_boreal <- read.csv('./European-Bioregions/boreal/fits-degree-dists-boreal-fraction-null2.csv')[-c(1,2)]
cur_fit_boreal <- cur_fit_boreal[match(unique(cur_fit_boreal$area), cur_fit_boreal$area),]
cur_fit_continental <- read.csv('./European-Bioregions/continental/fits-degree-dists-continental-fraction-null2.csv')[-c(1,2)]
cur_fit_continental <- cur_fit_continental[match(unique(cur_fit_continental$area), cur_fit_continental$area),]
cur_fit_pannonian <- read.csv('./European-Bioregions/pannonian/fits-degree-dists-pannonian-fraction-null2.csv')[-c(1,2)]
cur_fit_pannonian <- cur_fit_pannonian[match(unique(cur_fit_pannonian$area), cur_fit_pannonian$area),]
cur_fit_atlantic <- read.csv('./European-Bioregions/atlantic/fits-degree-dists-atlantic-fraction-null2.csv')[-c(1,2)]
cur_fit_atlantic <- cur_fit_atlantic[match(unique(cur_fit_atlantic$area), cur_fit_atlantic$area),]
cur_fit_steppic <- read.csv('./European-Bioregions/steppic/fits-degree-dists-steppic-fraction-null2.csv')[-c(1,2)]
cur_fit_steppic <- cur_fit_steppic[match(unique(cur_fit_steppic$area), cur_fit_steppic$area),]
cur_fit_blacksea <- read.csv('./European-Bioregions/blacksea/fits-degree-dists-blacksea-fraction-null2.csv')[-c(1,2)]
cur_fit_blacksea <- cur_fit_blacksea[match(unique(cur_fit_blacksea$area), cur_fit_blacksea$area),]
cur_fit_mediterranean <- read.csv('./European-Bioregions/mediterranean/fits-degree-dists-mediterranean-fraction-null2.csv')[-c(1,2)]
cur_fit_mediterranean <- cur_fit_mediterranean[match(unique(cur_fit_mediterranean$area), cur_fit_mediterranean$area),]
cur_fit_arctic <- read.csv('./European-Bioregions/arctic/fits-degree-dists-arctic-fraction-null2.csv')[-c(1,2)]
cur_fit_arctic <- cur_fit_arctic[match(unique(cur_fit_arctic$area), cur_fit_arctic$area),]
cur_fit_anatolian <- read.csv('./European-Bioregions/anatolian/fits-degree-dists-anatolian-fraction-null2.csv')[-c(1,2)]
cur_fit_anatolian <- cur_fit_anatolian[match(unique(cur_fit_anatolian$area), cur_fit_anatolian$area),]
cur_fit_alpine <- read.csv('./European-Bioregions/alpine/fits-degree-dists-alpine-fraction-null2.csv')[-c(1,2)]
cur_fit_alpine <- cur_fit_alpine[match(unique(cur_fit_alpine$area), cur_fit_alpine$area),]


cur_fit_salgal <- read.csv('./Salix/fits-degree-dists-salgal-fraction-null2.csv')[-c(1,2)]
cur_fit_salgal <- cur_fit_salgal[match(unique(cur_fit_salgal$area), cur_fit_salgal$area),]
cur_fit_galpar <- read.csv('./Salix/fits-degree-dists-galpar-fraction-null2.csv')[-c(1,2)]
cur_fit_galpar <- cur_fit_galpar[match(unique(cur_fit_galpar$area), cur_fit_galpar$area),]
cur_fit_pyrenees <- read.csv('./Pyrenees/fits-degree-dists-pyrenees-fraction-null2.csv')[-c(1,2)]
...
cur_fits_null2_null2 <- read.csv('./Soils/fits-degree-dists-soils-null-model.csv')
cur_fits_null2 <- cur_fits_null2[c('s_type','area','model','a','b')]
cur_fits_null2$s_type <- paste0('soils-',cur_fits_null2$s_type)
...
for(d in datasets){
  ...
  cur_fits_null2 <- rbind(cur_fits_null2, cbind(s_type=name, read.csv(file_loc)[c('area','model','a','b')]))
}

norm <- aggregate(cur_fits_null2$area, by = list(cur_fits_null2$s_type), max)
norm1 <- aggregate(cur_fits_null2$area, by = list(cur_fits_null2$s_type), min)
cur_fits_null2$area_norm <- (cur_fits_null2$area-norm1[match(cur_fits_null2$s_type, norm1$Group.1),]$x)/(norm[match(cur_fits_null2$s_type, norm$Group.1),]$x-norm1[match(cur_fits_null2$s_type, norm1$Group.1),]$x)
cur_fits_null2$model <- relevel(cur_fits_null2$model, 'mod1')

cur_fits_null2[which(cur_fits_null2$s_type == 'soils-1'),]$s_type <- 'Soil 1'
cur_fits_null2[which(cur_fits_null2$s_type == 'soils-2'),]$s_type <- 'Soil 2'
cur_fits_null2[which(cur_fits_null2$s_type == 'soils-3'),]$s_type <- 'Soil 3'
cur_fits_null2[which(cur_fits_null2$s_type == 'soils-4'),]$s_type <- 'Soil 4'
cur_fits_null2[which(cur_fits_null2$s_type == 'soils-5'),]$s_type <- 'Soil 5'
cur_fits_null2[which(cur_fits_null2$s_type == 'soils-6'),]$s_type <- 'Soil 6'
cur_fits_null2[which(cur_fits_null2$s_type == 'soils-7'),]$s_type <- 'Soil 7'

cur_fits_null2[which(cur_fits_null2$s_type == 'sanak'),]$s_type <- 'Sanak'
cur_fits_null2[which(cur_fits_null2$s_type == 'nahuel'),]$s_type <- 'Nahuel'
cur_fits_null2[which(cur_fits_null2$s_type == 'quercus'),]$s_type <- 'Quercus'
cur_fits_null2[which(cur_fits_null2$s_type == 'olot'),]$s_type <- 'Olot'
cur_fits_null2[which(cur_fits_null2$s_type == 'montseny'),]$s_type <- 'Montseny'
cur_fits_null2[which(cur_fits_null2$s_type == 'bristol'),]$s_type <- 'Bristol'
cur_fits_null2[which(cur_fits_null2$s_type == 'gottin-pp'),]$s_type <- 'Gottin PP'
cur_fits_null2[which(cur_fits_null2$s_type == 'gottin-hp'),]$s_type <- 'Gottin HP'
cur_fits_null2[which(cur_fits_null2$s_type == 'garraf-pp'),]$s_type <- 'Garraf PP'
cur_fits_null2[which(cur_fits_null2$s_type == 'garraf-pp-2'),]$s_type <- 'Garraf PP2'
cur_fits_null2[which(cur_fits_null2$s_type == 'garraf-hp'),]$s_type <- 'Garraf HP'
cur_fits_null2[which(cur_fits_null2$s_type == 'chaco'),]$s_type <- 'Chaco'

cur_fits_null2$s_type <- factor(as.character(cur_fits_null2$s_type), levels=sort(as.character(unique(cur_fits_null2$s_type)), decreasing=TRUE))


#### Run the code below to generate Figure 3e in the paper
png(filename = "degree_distributions_points.png", res= 300, width = 2300, height = 1600)
ggplot(cur_fits_null2 , aes(area_norm, s_type, color = factor(model))) +
  geom_point(size=.5) +
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
        axis.line = element_line(colour = "black"), axis.text=element_text(size=18),
        axis.title=element_text(size= 22 ,face="bold"),
