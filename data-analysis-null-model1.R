...
##
## Purpose of script: This script takes the output tables from the null model 1 analyses for all datasets
...
output_garraf_hp_null1 <- read.table("./Garraf-Montseny-Olot/output-garraf-hp-null-model-1.csv", sep=",", header=TRUE)[-1]
output_garraf_pp_null1 <- read.table("./Garraf-Montseny-Olot/output-garraf-pp-null-model-1.csv", sep=",", header=TRUE)[-1]
output_garraf_pp2_null1 <- read.table("./Garraf-Montseny-Olot/output-garraf-pp-2-null-model-1.csv", sep=",", header=TRUE)[-1]
output_montseny_null1 <- read.table("./Garraf-Montseny-Olot/output-montseny-null-model-1.csv", sep=",", header=TRUE)[-1]
output_olot_null1 <- read.table("./Garraf-Montseny-Olot/output-olot-null-model-1.csv", sep=",", header=TRUE)[-1]

output_nahuel_null1 <- read.table("./Nahuel/output-nahuel-null-model-1.csv", sep=",", header=TRUE)[-1]

output_quercus_null1 <- read.table("./Quercus/output-quercus-null-model-1.csv", sep=",", header=TRUE)[-1]
colnames(output_quercus_null1)[4] <- "resources"
colnames(output_quercus_null1)[5] <- "consumers"

output_soils_null1 <- read.table("./Soils/output-soils-null-model-1.csv", sep=",", header=TRUE)[-1]
output_soils_null1$resources <- output_soils_null1$S_basal
output_soils_null1$consumers <- output_soils_null1$S_intermediate + output_soils_null1$S_top

output_soils1_null1 <- output_soils_null1[(output_soils_null1$site_type==1),]
output_soils2_null1 <- output_soils_null1[(output_soils_null1$site_type==2),]
output_soils3_null1 <- output_soils_null1[(output_soils_null1$site_type==3),]
output_soils4_null1 <- output_soils_null1[(output_soils_null1$site_type==4),]
output_soils5_null1 <- output_soils_null1[(output_soils_null1$site_type==5),]
output_soils6_null1 <- output_soils_null1[(output_soils_null1$site_type==6),]
output_soils7_null1 <- output_soils_null1[(output_soils_null1$site_type==7),]

output_gottin_hp_null1 <- read.table("./Gottin/output-gottin-hp-null-model-1.csv", sep=",", header=TRUE)[-1]
colnames(output_gottin_hp_null1)[5] <- "resources"
colnames(output_gottin_hp_null1)[6] <- "consumers"

output_gottin_pp_null1 <- read.table("./Gottin/output-gottin-pp-null-model-1.csv", sep=",", header=TRUE)[-1]
colnames(output_gottin_pp_null1)[5] <- "resources"
colnames(output_gottin_pp_null1)[6] <- "consumers"

output_chaco_null1 <- read.table("./Chaco/output-chaco-null-model-1.csv", sep=",", header=TRUE)[-1]
names(output_chaco_null1)[3] <- "areas"

output_sanak_null1 <- read.table("./Sanak/output-sanak-null-model-1.csv", sep=",", header=TRUE)[-1]

output_bristol_null1 <- read.table("./Bristol/output-bristol-null-model-1.csv", sep=",", header=TRUE)[-1]
names(output_bristol_null1)[2] <- "areas"

## Once we have read all datasets we standardise their format and merge them into a single data frame
all_datasets <- cbind(data.frame(dataset='Garraf HP'), output_garraf_hp_null1)
all_datasets <- rbind(all_datasets, cbind(data.frame(dataset='Garraf PP'), output_garraf_pp_null1))
all_datasets <- rbind(all_datasets, cbind(data.frame(dataset='Garraf PP2'), output_garraf_pp2_null1))
all_datasets <- rbind(all_datasets, cbind(data.frame(dataset='Montseny'), output_montseny_null1))
all_datasets <- rbind(all_datasets, cbind(data.frame(dataset='Olot'), output_olot_null1))
...
all_datasets <- rbind(all_datasets, cbind(data.frame(dataset='Nahuel'), output_nahuel_null1[c('replicate', 'areas', 'species', 'links', 'links_per_sp', 'indegree', 'potential_indegree', 'resources', 'consumers')]))
all_datasets <- rbind(all_datasets, cbind(data.frame(dataset='Quercus'), output_quercus_null1[c('replicate', 'areas', 'species', 'links', 'links_per_sp', 'indegree', 'potential_indegree', 'resources', 'consumers')]))

output_soils_null1$dataset <- paste0('Soil ', output_soils_null1$site_type)
all_datasets <- rbind(all_datasets, output_soils_null1[c('dataset', 'replicate', 'areas', 'species', 'links', 'links_per_sp', 'indegree', 'potential_indegree', 'resources', 'consumers')])

all_datasets <- rbind(all_datasets, cbind(data.frame(dataset='Gottin HP'), output_gottin_hp_null1[c('replicate', 'areas', 'species', 'links', 'links_per_sp', 'indegree', 'potential_indegree', 'resources', 'consumers')]))
all_datasets <- rbind(all_datasets, cbind(data.frame(dataset='Gottin PP'), output_gottin_pp_null1[c('replicate', 'areas', 'species', 'links', 'links_per_sp', 'indegree', 'potential_indegree', 'resources', 'consumers')]))

all_datasets <- rbind(all_datasets, cbind(data.frame(dataset='Chaco'), output_chaco_null1[c('replicate', 'areas', 'species', 'links', 'links_per_sp', 'indegree', 'potential_indegree', 'resources', 'consumers')]))
all_datasets <- rbind(all_datasets, cbind(data.frame(dataset='Bristol'), output_bristol_null1[c('replicate', 'areas', 'species', 'links', 'links_per_sp', 'indegree', 'potential_indegree', 'resources', 'consumers')]))
all_datasets <- rbind(all_datasets, cbind(data.frame(dataset='Sanak'), output_sanak_null1[c('replicate', 'areas', 'species', 'links', 'links_per_sp', 'indegree', 'potential_indegree', 'resources', 'consumers')]))
...
write.csv(all_datasets, file='merged_datasets_replicates_nullmodel1.csv')
...
output_galpar <- read.table("./Salix/output-galpar-null-model-1.csv", sep=",", header=TRUE)[-1]
colnames(output_galpar)[4] <- "resources"
colnames(output_galpar)[5] <- "consumers"

output_salgal <- read.csv("./Salix/output-salgal-null-model-1.csv", sep=",", header=TRUE)[-1]
colnames(output_salgal)[4] <- "resources"
colnames(output_salgal)[5] <- "consumers"

output_pyrenees <- read.csv("./Pyrenees/output-pyrenees-null-model-1.csv", header=TRUE)[-1]
...
europe_datasets <- read.table("./European-Bioregions/output-europe-null-model-1.csv", sep=",", header=TRUE, stringsAsFactors = F)[-1]
...
#### In case you want to store the pre-processed data to have it all ready for the next time this script is run.
write.csv(biogeographical_datasets, file='merged_biogeographical-data_null1.csv')
#### Here we summarise and normalise the data
...
properties <-  c('species', 'links', 'links_per_sp', 'indegree', 'potential_indegree')
...
write.csv(output_models_reps, file='fits-sars-replicates-nullmodel1.csv')
...
write.csv(output_models_biogeo, file='fits-sars-bioregions-nullmodel1.csv')
...
write.csv(models_links_sp, file = 'fits-species-links-relationships-relationships.csv')
...
ggplot(all_summaries_replicates_norm, aes(x=log10(areas), y=(species), colour=dataset)) + 
  geom_line() +
  geom_point() + theme_bw() + ylab('log10(Species)') + xlab('log10(Area)')+
